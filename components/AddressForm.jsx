    ...
    return (
        <form className="md:w-2/3 md:mx-auto px-3 pt-1" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-4 md:flex md:justify-between">
                ...
                <div className="mb-4 md:mr-2 md:mb-0 flex-1">
                    <label className="block mb-2 text-sm font-bold text-gray-700" for="postcode">Postcode</label>
                    <input
                ...
                />
                {errors.postcode && <span className="text-red-500">This field is required</span>}
                </div>
            </div>
